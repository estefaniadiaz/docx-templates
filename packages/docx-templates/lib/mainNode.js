...
var createReport = function () {
  var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(options) {
    var template, replaceImages, _probe, buffer, output, fileBuffer, newOptions, imgDataBase64, imgNames, i, imgName, imgPath, imgBuf, report;

    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            template = options.template, replaceImages = options.replaceImages, _probe = options._probe, buffer = options.buffer;
          ...
          case 6:
            ...
            newOptions = (0, _timm.set)(options, 'template', fileBuffer);
